...
class TRAD_3D_Carousel_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('3D Carousel', 'turbo-addons-elementor');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            'image',
            [
                'label' => __('Choose Image', 'turbo-addons-elementor'),
        ...
        $this->add_control(
            'carousel_images',
            [
                'label' => __('Carousel Images', 'turbo-addons-elementor'),
    ...
    $this->add_control(
        'animation_speed',
        [
            'label' => __('Sliding Animation Speed (seconds)', 'turbo-addons-elementor'),
            'type' => Controls_Manager::NUMBER,
            'default' => 15,
            'min' => 1,
            'max' => 60,
            'step' => 1,
            'description' => __('Set the animation speed in seconds', 'turbo-addons-elementor'),
        ]
    );
    ...
    $this->add_control(
        'animation_direction',
        [
            'label' => __('Sliding Direction', 'turbo-addons-elementor'),
            'type' => Controls_Manager::SELECT,
            'default' => 'clockwise',
            'options' => [
                'clockwise' => __('Clockwise', 'turbo-addons-elementor'),
                'counterclockwise' => __('Counterclockwise', 'turbo-addons-elementor'),
    ...
    $this->add_control(
        ...
        [
            'label' => __( 'Pause on Hover (See the hover Effect in live)', 'turbo-addons-elementor' ),
...
$this->end_controls_section();
    ...
    $this->start_controls_section(
        ...
        [
            'label' => __( 'Slider Container', 'turbo-addons-elementor' ),
    ...
    $this->start_controls_section(
        'style_section',
        [
            'label' => __('Slide Style', 'turbo-addons-elementor'),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    ...
    $this->start_controls_section(
        'shape_style_section',
        [
            'label' => __('Shape Style', 'turbo-addons-elementor'),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
