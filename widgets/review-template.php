...
class TRAD_Review_Archive extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Turbo Review Archive', 'turbo-addons-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'template-1' => esc_html__( 'Template 1', 'turbo-addons-elementor' ),
                    'template-2' => esc_html__( 'Template 2', 'turbo-addons-elementor' ),
                    'template-3' => esc_html__( 'Template 3', 'turbo-addons-elementor' ),
                    'template-4' => esc_html__( 'Template 4', 'turbo-addons-elementor' ),
                    'template-5' => esc_html__( 'Template 5', 'turbo-addons-elementor' ),
                ],
                'default' => 'template-1',
            ]
        );
        ...
        $this->add_control(
            'logo_border_radius',
            [
                'label' => esc_html__( 'Logo Border Radius', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Title', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter your title', 'turbo-addons-elementor' ),
                'condition' => [
        ...
        $this->add_control(
            'dynamic_content',
            [
                'label' => esc_html__( 'Dynamic Content', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__( 'Default content', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter your content', 'turbo-addons-elementor' ),
                'condition' => [
        ...
        $this->add_control(
            'money_back_title',
            [
                'label' => esc_html__( 'Guarantee Text', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Guarantee Text', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter your guarantee', 'turbo-addons-elementor' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Price Text', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Price Text', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter your Price', 'turbo-addons-elementor' ),
                'condition' => [
                    'template_select' => ['template-3', 'template-5'],
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Save Text', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Save Text', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter your Save', 'turbo-addons-elementor' ),
                'condition' => [
                    'template_select' => ['template-3', 'template-5'],
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secure Text', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Secure Text', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter your Secure', 'turbo-addons-elementor' ),
                'condition' => [
                    'template_select' => ['template-3', 'template-5'],
                ],
            ]
        ...
        $this->start_controls_section(
            'review_section',
            [
                'label' => esc_html__( 'Review', 'turbo-addons-elementor' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'number_of_stars',
            [
                'label' => esc_html__('Number of Stars', 'turbo-addons-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Visit', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            'button_text_two',
            [
                'label' => esc_html__( 'Review Button', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Read Review', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter review text', 'turbo-addons-elementor' ),
                'condition' => [
                    'template_select' => ['template-3', 'template-5'],
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Link', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::URL,
                'placeholder' => esc_html__( 'https://your-link.com', 'turbo-addons-elementor' ),
                'default' => [
                    'url' => '#',
        ...
        $this->start_controls_section(
            'tc_section',
            [
                'label' => esc_html__( 'Terms & Condition', 'turbo-addons-elementor' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [
                    'template_select' => ['template-1', 'template-3', 'template-4', 'template-5'],
                ],
        ...
        $this->add_control(
            'tc_text',
            [
                'label' => esc_html__( 'Terms and Condition Text', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'T&Cs Apply', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter term and condition text', 'turbo-addons-elementor' ),
                'condition' => [
                    'template_select' => 'template-1',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Terms and Condition Text', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Terms and condition apply', 'turbo-addons-elementor' ),
                'placeholder' => esc_html__( 'Enter term and condition text', 'turbo-addons-elementor' ),
                'condition' => [
                    'template_select' => 'template-5',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Price Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Save', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Save Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Secure', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secure Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Money Back', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Money Back Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Button Background Color - 1', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#6a33d8',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Text Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#000',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Font Size', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'em', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Hover Text Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Background Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#6a33d8',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Text Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#ffffff',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Font Size', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'em', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Width', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'em' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Border Radius', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Hover Background Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Button Hover Text Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Terms Typography', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            'tc_text_color',
            [
                'label' => esc_html__( 'Terms Text Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
