...
class TRAD_Testimonial_Slider extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Turbo Testimonial Slider', 'turbo-addons-elementor');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__('Testimonials', 'turbo-addons-elementor'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Mr. Turbo', 'turbo-addons-elementor'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('San Francisco, USA', 'turbo-addons-elementor'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_content',
            [
                'label' => esc_html__('Testimonial Content', 'turbo-addons-elementor'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('Discover Turbo Addons: empowering your creativity with a complete suite of tools to bring your design vision to life.', 'turbo-addons-elementor'),
            ]
        );
        ...
        $this->add_control(
            'testimonials_list',
            [
                'label' => esc_html__('Testimonials List', 'turbo-addons-elementor'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'testimonial_image' => ['url' => esc_url(TRAD_TURBO_ADDONS_PLUGIN_URL . 'assets/images/trad-testimonial.jpg')],
                        'testimonial_name' => esc_html__('Mr. Turbo', 'turbo-addons-elementor'),
                        'testimonial_location' => esc_html__('San Francisco, USA', 'turbo-addons-elementor'),
                        'testimonial_content' => esc_html__('Discover Turbo Addons: empowering your creativity with a complete suite of tools to bring your design vision to life.', 'turbo-addons-elementor'),
                    ],
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Slider Speed', 'turbo-addons-elementor'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'slider_speed',
            [
                'label' => esc_html__('Slider Speed (ms)', 'turbo-addons-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Location Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Location Typography', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Location Alignment', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'turbo-addons-elementor' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Text Typography', 'turbo-addons-elementor' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Dot Width', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'em' ],
                'default' => [
                    'size' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Dot Height', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'em' ],
                'default' => [
                    'size' => 10,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Active Dot Background Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Controls Alignment', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Description Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Review Description Typography', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Heading Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Review Heading Typography', 'turbo-addons-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Review Author Color', 'turbo-addons-elementor' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#808080',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Review Author Typography', 'turbo-addons-elementor' ),
